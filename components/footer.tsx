...
const footerLinks = {
  الشركة: [
    { label: "من نحن", href: `${basePath}/about` },
    { label: "خدماتنا", href: `${basePath}/services` },
    { label: "مشاريعنا", href: `${basePath}/projects` },
    { label: "تواصل معنا", href: `${basePath}/contact` },
  ],
  الخدمات: [
    { label: "استشارات ذكاء اصطناعي", href: `${basePath}/services` },
    { label: "بناء استراتيجية AI", href: `${basePath}/services` },
    { label: "تطوير حلول مخصصة", href: `${basePath}/services` },
        ...
        <ScrollAnimation animation="fade-up">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-1">
              <a href={`${basePath}/`} className="flex items-center gap-2 mb-5">
                <img src={`${basePath}/logo-01.png`} alt="سند تكنو" className="h-8 w-auto" />
              </a>
